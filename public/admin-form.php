...
<div id="content" class="container col-md-12">
	...
	<div class="form-group">
		<label for="field-1" class="col-sm-3 control-label">Old Password :</label>					
			<div class="col-sm-5">			
				...
				<?php echo isset($error['old_password']) ? $error['old_password'] : '';?>
			</div>
	</div>
	...
	<div class="form-group">
		<label for="field-1" class="col-sm-3 control-label">New Password :</label>					
			<div class="col-sm-5">			
				...
				<?php echo isset($error['new_password']) ? $error['new_password'] : '';?>
			</div>
	</div>

	<div class="form-group">
		<label for="field-1" class="col-sm-3 control-label">Re Type New Password :</label>					
			<div class="col-sm-5">			
	...
	<div class="form-group">		
			<div class="col-sm-offset-3 col-sm-5">
				<input type="submit" class="btn btn-default" value="Change" name="btnChange"/>	
			</div>
	</div>	
