...
<div class="col-md-9">
	...
	<div id="option_menu">
			<a href="edit-product.php?id=<?php echo $ID; ?>"><button class="btn btn-primary">Edit</button></a>
			<a href="delete-product.php?id=<?php echo $ID; ?>"><button class="btn btn-danger">Delete</button></a>
	</div>
